  ...
  return (
    <div className="banner">
      <div className="container container-lg">
        <div className="banner-item bg-main-200 rounded-24 overflow-hidden position-relative arrow-center">
          <a
            href="#featureSection"
                ...
                <div className="banner-slider__inner flex-between position-relative">
                  <div className="banner-item__content">
                    <h1 className="banner-item__title bounce">
                      Daily Bazario Order and Get Express Delivery
                    </h1>
                    <Link
                      to="/shop"
                      className="btn text-black btn-main bg-main-600 border-main-600 bg-main-600 d-inline-flex align-items-center rounded-pill gap-8"
                    >
                      Explore Shop{" "}
              ...
              <div className="banner-slider__item">
                <div className="banner-slider__inner flex-between position-relative">
                  <div className="banner-item__content">
                    ...
                    <Link
                      to="/shop"
                      className="btn btn-main bg-main-600 border-main-600  bg-main-600 d-inline-flex align-items-center rounded-pill gap-8"
                    >
                      Explore Shop{" "}
                      <span className="icon text-xl d-flex">
                        <i className="ph ph-shopping-cart-simple" />{" "}
