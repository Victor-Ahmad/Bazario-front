...
const NewsletterOne = () => {
  return (
    <div className="newsletter py-80">
            ...
            <div className="col-xl-6">
              <div className="">
                ...
                <form action="#" className="position-relative mt-40">
                  ...
                  <button
                    type="submit"
                    className="btn btn-main bg-main-600 border-main-600 rounded-pill position-absolute top-50 translate-middle-y inset-inline-end-0 me-10"
                  >
                    Subscribe
                  </button>
                </form>
