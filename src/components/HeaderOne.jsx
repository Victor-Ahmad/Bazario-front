...
import { getAuthToken, isCustomer } from "../api/auth";
...
const HeaderOne = () => {
  ...
  useEffect(() => {
    const onStorageChange = () => setIsLoggedIn(!!getAuthToken());
                ...
                {isLoggedIn ? (
                  <li>
                    <button
                      ...
                      className="text-white text-sm py-8 flex-align gap-6 bg-transparent border-0"
              ...
              <div className="header-menu d-lg-block d-none">
                ...
                <ul className="nav-menu flex-align ">
                  ...
                  <li className="on-hover-item nav-menu__item ">
                    <Link
                      to="/shop"
                      className="nav-menu__link  hover-text-main-600"
                    >
                      Shop
                    </Link>
                  </li>
                    ...
                    >
                      <div className="search-category d-flex h-48 select-border-end-0 radius-end-0 search-form d-sm-flex d-none">
                        ...
                        <div className="search-form__wrapper position-relative">
                          ...
                          <button
                            type="submit"
                            className="w-32 h-32 bg-brand rounded-circle flex-center text-xl text-white position-absolute top-50 translate-middle-y inset-inline-end-0 me-8"
                          >
                            <i className="ph ph-magnifying-glass" />
                          </button>
                        </div>
                ...
                <div className="line-height-1">
                  ...
                  {/* <li className="on-hover-item nav-menu__item">
                    <Link to="/become-seller" className="nav-menu__link">
                      Become A Seller
                    </Link>
                  </li>
                  <li className="on-hover-item nav-menu__item">
                  ...
                  <li className="on-hover-item nav-menu__item">
                    <Link
                      to="/account"
                      className="nav-menu__link  text-sm py-8 flex-align gap-6"
                    >
                      <span className="icon text-md d-flex">
                        {" "}
                        <i className="ph ph-user-circle" />{" "}
