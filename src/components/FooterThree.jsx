        ...
        <div className="container container-lg">
          <div className="footer-item-two-wrapper d-flex align-items-start flex-wrap">
            <div className="footer-item max-w-275">
              ...
              <p className="mb-24">
                Bazario become the largest computer parts, gaming pc parts, and
              ...
              <div className="flex-align gap-16 mb-16">
                ...
                <a
                  href="mailto:support24@bazario.com"
                  className="text-md text-gray-900 hover-text-main-600"
                >
            ...
            <div className="footer-item">
              ...
              <p className="mb-16">Bazario App is available. Get it now</p>
        ...
        <div className="container container-lg">
          <div className="bottom-footer__inner flex-between flex-wrap gap-16 py-16">
            <p className="bottom-footer__text ">
              Bazario eCommerce © 2024. All Rights Reserved
            </p>
