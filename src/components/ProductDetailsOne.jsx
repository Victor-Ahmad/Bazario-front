                ...
                <div className="product-details__content">
                  ...
                  <div className="mt-32 flex-align flex-wrap gap-32">
                    ...
                    {isCustomer() && (
                      <Link
                        to="#"
                        className="btn btn-main bg-main-600 border-main-600  rounded-pill  bg-main-600 border-main-600"
                      >
                        Order on What'sApp
                      </Link>
                    )}
                  ...
                  <div className="flex-between gap-16 flex-wrap">
                    {isCustomer() && (
                      <div className="flex-align flex-wrap gap-16">
                        ...
                        <Link
                          to="#"
                          className="btn btn-main bg-main-600 border-main-600 rounded-pill flex-align d-inline-flex gap-8 px-48"
                        >
                          {" "}
              ...
              <div className="p-24">
                <div className="flex-between bg-main-600 rounded-pill p-8">
                  <div className="flex-align gap-8">
                    ...
                    <span className="text-white">by Bazario</span>
                  </div>
                  <Link
                    to="/shop"
                      ...
                      <div className="mt-56">
                        ...
                        <div className="mt-32">
                          <form action="#">
                            ...
                            <button
                              type="submit"
                              className="btn btn-main bg-main-600 border-main-600 rounded-pill mt-48"
                            >
                              Submit Review
                            </button>
                          </form>
