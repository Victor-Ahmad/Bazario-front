              ...
              <form action="#">
                ...
                <div className="row gy-4">
                  ...
                  <div className="col-sm-12 mt-32">
                    <button
                      type="submit"
                      className="btn btn-main bg-main-600 border-main-600 py-18 px-32 rounded-8"
                    >
                      Post Comment
                    </button>
                  </div>
            ...
            <div className="my-48">
              <form action="#">
                ...
                <div className="mt-48">
                  <button
                    type="submit"
                    className="btn btn-main bg-main-600 border-main-600 py-13 flex-align gap-8"
                  >
            ...
            <div className="blog-sidebar border border-gray-100 rounded-8 p-32 mb-40">
              ...
              <form action="#">
                <div className="input-group">
                  ...
                  <button
                    type="submit"
                    className="btn btn-main bg-main-600 border-main-600 text-2xl h-56 w-56 flex-center text-2xl input-group-text"
                  >
